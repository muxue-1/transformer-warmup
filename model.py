...
class TransformerLayer(nn.Module):
    ...
    def __init__(self, hidden_dim, head_num, f_hidden_dim):
        super().__init__()
        self.hidden_dim = hidden_dim
        self.head_num = head_num

        self.self_attn = MultiHeadAttentionWithKVCache(hidden_dim, head_num)
...
class Transformer(nn.Module):
    ...
    def __init__(self, vocab_size, hidden_dim, layer_num, head_num, max_len, f_hidden_dim=None):
        super().__init__()
        ...
        self.layers = nn.ModuleList([
            TransformerLayer(hidden_dim, head_num, f_hidden_dim) 
